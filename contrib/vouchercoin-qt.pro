...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/vouchercoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/vouchercoin-cli.cpp \
           src/vouchercoin-tx.cpp \
           src/vouchercoin.cpp \
           src/db.cpp \
           ...
           src/qt/vouchercoin.cpp \
           src/qt/vouchercoinstrings.cpp \
...
RESOURCES += src/qt/vouchercoin.qrc src/qt/vouchercoin_locale.qrc

TRANSLATIONS += src/qt/locale/vouchercoin_bg.ts \
                src/qt/locale/vouchercoin_de.ts \
                src/qt/locale/vouchercoin_en.ts \
                src/qt/locale/vouchercoin_es.ts \
                src/qt/locale/vouchercoin_fi.ts \
                src/qt/locale/vouchercoin_fr.ts \
                src/qt/locale/vouchercoin_it.ts \
                src/qt/locale/vouchercoin_ja.ts \
                src/qt/locale/vouchercoin_pl.ts \
                src/qt/locale/vouchercoin_pt.ts \
                src/qt/locale/vouchercoin_ru.ts \
                src/qt/locale/vouchercoin_sk.ts \
                src/qt/locale/vouchercoin_sv.ts \
                src/qt/locale/vouchercoin_vi.ts \
                src/qt/locale/vouchercoin_zh_CN.ts \
                src/qt/locale/vouchercoin_zh_TW.ts
