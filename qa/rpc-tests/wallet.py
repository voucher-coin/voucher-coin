...
#   c) node1 mines 32 blocks, so now node 0 has 60001vco, node 1 has 4250vco, node2 has none.
#   d) node0 sends 601 vco to node2, in two transactions (301 vco, then 300 vco).
