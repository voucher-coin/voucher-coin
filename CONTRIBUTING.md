Contributing to VoucherCoin Core
============================

The VoucherCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VoucherCoin Core project, and is not to be
confused with overall VoucherCoin Network Protocol consensus changes.

Whether a pull request is merged into VoucherCoin Core rests with the project merge
...
Patches that change VoucherCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the VoucherCoin consensus, it must have been
...
The project leader is the release manager for each VoucherCoin Core release.
