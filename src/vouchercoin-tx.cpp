...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VoucherCoin Core vouchercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vouchercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vouchercoin transaction") + "\n" +
                               "  vouchercoin-tx [options] -create [commands]   " + _("Create hex-encoded vouchercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vouchercoin transaction
