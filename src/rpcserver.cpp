...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VoucherCoin features */
        {"vouchercoin", "masternode", &masternode, true, true, false},
        {"vouchercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"vouchercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vouchercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vouchercoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"vouchercoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"vouchercoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"vouchercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vouchercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"vouchercoin", "startmasternode", &startmasternode, true, true, false},
        {"vouchercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vouchercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vouchercoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vouchercoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vouchercoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vouchercoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vouchercoin", "mnbudget", &mnbudget, true, true, false},
        {"vouchercoin", "preparebudget", &preparebudget, true, true, false},
        {"vouchercoin", "submitbudget", &submitbudget, true, true, false},
        {"vouchercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vouchercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vouchercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vouchercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vouchercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vouchercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vouchercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vouchercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"vouchercoin", "mnsync", &mnsync, true, true, false},
        {"vouchercoin", "spork", &spork, true, true, false},
        {"vouchercoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzvcoseed", &getzvcoseed, false, false, true},
        {"zerocoin", "setzvcoseed", &setzvcoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzvco", &searchdzvco, false, false, true},
        {"zerocoin", "dzvcostate", &dzvcostate, false, false, true}
...
{
    return "> vouchercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6313/\n";
}
