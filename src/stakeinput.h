...
#ifndef VoucherCoin_STAKEINPUT_H
#define VoucherCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZVCO() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zVCOStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zvco, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZVCO() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZVCO() override { return false; }
};


#endif //VoucherCoin_STAKEINPUT_H
