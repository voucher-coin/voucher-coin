...
/**
 * VoucherCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzvcoseed(const UniValue& params, bool fHelp);
extern UniValue getzvcoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzvco(const UniValue& params, bool fHelp);
extern UniValue dzvcostate(const UniValue& params, bool fHelp);
