...
/** Utility functions used by the VoucherCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render VoucherCoin addresses in monospace font
...
// Parse "vouchercoin:" URI into recipient object, return true on successful parsing
