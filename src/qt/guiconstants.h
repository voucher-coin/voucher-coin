...
/* VoucherCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "VoucherCoin"
#define QAPP_ORG_DOMAIN "voucher-co.in"
#define QAPP_APP_NAME_DEFAULT "VoucherCoin-Qt"
#define QAPP_APP_NAME_TESTNET "VoucherCoin-Qt-testnet"
