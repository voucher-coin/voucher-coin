                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVCOPathCustom = GetArg("-zvcobackuppath", "");
    ...
    if(!strzVCOPathCustom.empty()) {
        ui->wallet_customzvcobackuppath->setText(QString::fromStdString(strzVCOPathCustom));
        ui->wallet_customzvcobackuppath_label->setVisible(true);
        ui->wallet_customzvcobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVCOPathCustom.empty()) && nCustomBackupThreshold > 0) {
