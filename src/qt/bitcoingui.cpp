                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VoucherCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vouchercoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVCO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VoucherCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about VoucherCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a VoucherCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VoucherCoin Core help message to get a list with possible VoucherCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VoucherCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("VoucherCoin Core"); // default title
