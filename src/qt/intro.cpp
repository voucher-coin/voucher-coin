...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("VoucherCoin Core"),
     ...
     * override -datadir in the vouchercoin.conf file in the default data directory
     * (to be consistent with vouchercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
