...
This mechanism has been integrated into Bitcore-Node-VoucherCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/VoucherCoin-Project/insight-api-vouchercoin#web-socket-api](https://github.com/VoucherCoin-Project/insight-api-vouchercoin#web-socket-api) 
* API: [https://github.com/VoucherCoin-Project/insight-api-vouchercoin#swifttx-transactions](https://github.com/VoucherCoin-Project/insight-api-vouchercoin#swifttx-transactions) 
...
By default, the VoucherCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VoucherCoin Core daemon:
