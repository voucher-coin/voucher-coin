...
In order to support loading of multiple wallets in vouchercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vouchercoin.cpp.
...
Changes to vouchercoin.cpp
----------------------
vouchercoin.cpp is the entry point into vouchercoin-qt, and as such, will require some minor modifications to provide hooks for
